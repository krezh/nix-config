{
  ...
  inputs = {
    ...
    nix-cachyos-kernel = {
      url = "github:xddxdd/nix-cachyos-kernel/0a3ea372e89fcf6ecea6acb17e19381fb2e1e702";
      inputs = {
    ...
    zen-browser = {
      url = "github:0xc000022070/zen-browser-flake/2c997bca3b19f8af39e82038646f20e6c92d65ff";
      inputs = {
        nixpkgs.follows = "nixpkgs";
