{
  ...
  inputs = {
    ...
    nix-cachyos-kernel = {
      url = "github:xddxdd/nix-cachyos-kernel/a5587fa71706494266154d0104932f719ec98b20";
      inputs = {
    ...
    zen-browser = {
      url = "github:0xc000022070/zen-browser-flake/ec2c94c95846c36130edb9872a8ca4c203028c84";
      inputs = {
        nixpkgs.follows = "nixpkgs";
