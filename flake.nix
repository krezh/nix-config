{
  ...
  inputs = {
    ...
    nix-cachyos-kernel = {
      url = "github:xddxdd/nix-cachyos-kernel/b8538a38adfd2a443aa0f8f3d506c29161f71f5f";
      inputs = {
    ...
    zen-browser = {
      url = "github:0xc000022070/zen-browser-flake/36f84edf5f170d460ab3a1723b9283f169b817c7";
      inputs = {
        nixpkgs.follows = "nixpkgs";
