...
sed -i "s|version = \".*\";|version = \"${latestVersion}\";|" ./default.nix
sed -i "s|linuxHash = \"sha256-[^\"]*\";|linuxHash = \"${latestLinuxSha}\";|" ./default.nix
sed -i "s|darwinHash = \"sha256-[^\"]*\";|darwinHash = \"${latestDarwinSha}\";|" ./default.nix
